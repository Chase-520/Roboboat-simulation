...
def generate_launch_description():
    # 获取默认路径
    robot_name_in_model = "barocopolo"
    urdf_tutorial_path = get_package_share_directory('boat_description')
    default_model_path = urdf_tutorial_path + '/urdf/boat/boat.urdf.xacro'
    default_world_path = urdf_tutorial_path + '/world/first_world.world'
    # 为 Launch 声明参数
